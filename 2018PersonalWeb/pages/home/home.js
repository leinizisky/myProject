Page({
  ...
  data: {
    ...
    jobInfo: [
      { time: "2015/07-2017/05", name: "公司名称", duty: "前端开发" },
    ...
    project: [
      { time: "2017/05-2017/05", name: "严选项目", company: "公司名称" },
      { time: "2017/04-2017/04", name: "物料订单项目", company: "公司名称" },
      { time: "2017/03-2017/03", name: "周年庆项目", company: "公司名称" },
      { time: "2017/01-2017/01", name: "人气排行项目", company: "公司名称" }
    ],
    skills:[
